...
heading = Label(base, text="HOSTEL MANAGEMENT SYSTEM", font=("Arial 30 bold"), bg="red", fg="white", padx=490, pady=20)
heading.pack()
...
def main():
    ...
    def add_stud():
        ...
        contact = Label(base, text="College_ID", font=("Arial 15 bold"), bg="silver", fg="black")
        contact.place(x=610, y=300)
        cont_entry = Entry(base, width=15, font=("Arial 15 bold"))
        cont_entry.place(x=610, y=330)

        message = Label(base, text="", font=("Arial 10 bold"), bg="silver",
                        fg="black")
        message.place(x=690, y=300)

        email = Label(base, text="Email_Id", font=("Arial 15 bold"), bg="silver", fg="black")
        ...
        work_place = Label(base, text="College_Name [SISTK/SIETK]", font=("Arial 15 bold"), bg="silver", fg="black")
    ...
    def view_info():
        ...
        def all_girl_info():
            ...
            h = "Room NO.           Name             College_ID             College_Name"
        ...
        def room_wise():
            ...
            def search():
                ...
                h = "Bed No.              Name                 College_ID                College_Name"
                h2 = Label(base, text=h, font=("Arial 20 bold"), bg="dark orange", fg="white")
...
def login():
    ...
    if id == "Piyush@111" and key == "Piyush@01":
        main()
    else:
        user_entry.focus()
...
login_btn = Button(base, text="Login", font=("Arial 25 bold"), bg="blue", fg="white", command=login)
